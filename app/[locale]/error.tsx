...
// Jiyan ژیان — Locale-specifik error boundary
// Krävs av Next.js 14 App Router för att hantera fel i [locale]-segmentet
// Ärver locale från sin närmaste föräldralayout
